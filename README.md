...
### Supported versions
- PrestaShop 1.7.7 – 1.7.8, PrestaShop 8
- PHP 7.1 - PHP 8.1
...
- Changing order status if shipment status changes.
- Widget at checkout does not offer z-box if there is a product with required age-verification in the cart.
...
- Sledování stavu zásilek.
- Změna stavu objednávky, pokud se změní stav zásilky.
- Widget v pokladně nenabízí z-box, pokud je v košíku produkt s ověřením věku.
