...
function upgrade_module_3_0_0($module)
{
    ...
    if (!$dbTools->executeQueries($sql, $module->getTranslator()->trans('Exception raised during Packetery module upgrade:', [], 'Modules.Packetery.Upgrade'), true)) {
        return false;
    }
    ...
    if ($internalPickupPointCarriers) {
        ...
        if (!$dbTools->executeQueries($carrierUpdates, $module->getTranslator()->trans('Exception raised during Packetery module upgrade:', [], 'Modules.Packetery.Upgrade'), true)) {
            return false;
        }
    }
