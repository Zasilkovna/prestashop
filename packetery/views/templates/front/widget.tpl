...
<div id="packetery-carrier-{$carrier_id|escape:'htmlall':'UTF-8'}">
    ...
    <div id="packetery-widget" class="clearfix">
        <div class="widget-left">
            <div class="col-md-12">
                <div class="zas-box">
                    <div class="clearfix">
                        <button class="btn btn-sm btn-success pull-left open-packeta-widget" id="open-packeta-widget">{l s='Select pick-up point:' mod='packetery' d='Modules.Packetery.Widget'}</button>
                    </div>
                    <ul id="selected-branch">
                        <li>{l s='Selected pick-up point:' mod='packetery' d='Modules.Packetery.Widget'}
    ...
    <div class="packetery-message-pickup-point-not-selected-error" data-content="{l s='Please select a pick up point before confirming your order' mod='packetery' d='Modules.Packetery.Widget'}"></div>
</div>
