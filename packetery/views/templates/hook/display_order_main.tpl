    ...
    <div class="card-body">
        ...
        <form action="{$returnUrl}" method="post">
            {if $isAddressDelivery}
                ...
                {/if}
                {if isset($widgetOptions) && !$isExported && $canUserEditOrders}
                    <p>
            ...
            {else}
                ...
                {if $pickupPointChangeAllowed && !$isExported && $canUserEditOrders}
                    <p>
        ...
        {if $showActionButtonsDivider}
            <hr />
        {/if}
        {if $postParcelButtonAllowed && $canUserEditOrders}
            <form action="{$returnUrl}" method="post">
                <p>
